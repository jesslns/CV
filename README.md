...
| :---- | :---- | :---- | :---- |
|AsanaApp<br>([Github](https://github.com/nomats/asanaApp))|A yoga pose app that can check if the user has the correct pose. <br> The app can capture a user's pose through a webcam and send data to PoseNet(a machine learning model that allows for real-time human pose estimation). PoseNet then returns spatial data from 17 pose key points. Those data will be processed by a model that we implemented and check if relationship between keypoints can fulfill the criteria for a certain yoga pose. Key experience:<br><li>Setting up deployment pipeline with Travis CI for quality assurance</li><li>Handling and processing real-time spatial data</li>|2 weeks|JavaScript, REACT, PoseNet API,<br>Testing with Jest, Travis(CI)|
|Acebook<br> [(back-end API)](https://github.com/ellieturno/acebook-team-byteme)<br>[(front-end with REACT)](https://github.com/ellieturno/bytebook-frontend)|A facebook clone that was developed using Agile methodology. I was heavily involved in devloping the backend API, which is RESTful and adpopted the MVC pattern. Our team learnt collaborately when applying new technologies, which include:<br> <li> Building the API with Node.js and Express framework,</li> <li> Use of NoSQL (MongoDB),</li><li> Use of Mongoose ORM to interact with the database,</li> <li> Hashing and salting user password with bcrypt in Node.js,</li><li>Use of Jason Web Token to authenticate user.</li> |2 weeks|Node.js, Express, MongoDB, Mongoose, REACT|
...
- Great collaborator:
  - Positive feedbacks from team members:
  <br>I am able to communicate my work and am able to facilitate ideas in planning meetings.
  - Can grow and learn in a peer-to-peer environment.
- OOP, TDD, MVC, DDD
- Agile/XP
- Ruby, Rails, JavaScript, Node.js, Express
- RSpec, Jasmine, Jest, Travis
...
*GIS Programmer*  
Develop mapping applications.<br>
Assist in writing technical documentation.<br>
Technology Stack: Vue.Js, Node.JS, MSSQL <br>
